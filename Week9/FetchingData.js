...
(async function fetchData(dataArray = []) {
    ...
    const urlArray = [
      'https://api.openweathermap.org/data/2.5/weather?q=London,uk&APPID=8362e718e5a186a54c0cf57e9b94d40d',
      'https://api.openweathermap.org/data/2.5/weather?q=Houston&APPID=8362e718e5a186a54c0cf57e9b94d40d',
      'https://api.openweathermap.org/data/2.5/weather?q=Lisbon&APPID=8362e718e5a186a54c0cf57e9b94d40d',
      'https://api.openweathermap.org/data/2.5/weather?q=Budapest&APPID=8362e718e5a186a54c0cf57e9b94d40d',
    ];
