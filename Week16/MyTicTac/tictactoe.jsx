const Board = () => {
    ...
    let turn = `Next Player: Player ${player=='0' ? '0' : 'X'}`;
    ...
    function renderSquare(i) {
      ...
      return <Square checkWin={checkWin} takeTurn={takeTurn} id={i}></Square>;
    }
    ...
    return (
      <div className="game-board">
        ...
        <div id="info">
          <h1 id="turn">{turn}</h1>
          <h1>{status}</h1>
          <button className="reset" onClick={()=>setMount(!mount)}>New Game</button> 
        </div>
      </div>
    );
  };
