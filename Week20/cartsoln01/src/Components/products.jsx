//Took this from the work i did in week 19

// importing the required stuff to make this run - to do that i ran npm import axios and npm inmport react
import *as React from "react";
import *as ReactBootstrap from 'react-bootstrap';
import axios from 'axios';
//will import everythign we need from bootsrap, last week we did this inside the Products function
import {
    Card,
    Accordion,
    Button,
...
// LIAM: gets our baseline before we call the DB
const products = [
  ...
  // this lets App.js grap it
export default Products;
  // remove this for this method, we're going to do it through App
  // ========================================
